...
* Breaking: Remove `install` script.
  ...
  [WebAssembly](https://sharp.pixelplumbing.com/install/#webassembly) or
  [build from source](https://sharp.pixelplumbing.com/install/#building-from-source) manually.
