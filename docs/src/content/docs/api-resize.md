...
| [extend.top] | <code>number</code> | <code>0</code> | number of pixels to add to the top edge, valid values are integers in the range 0-100000000 |
| [extend.left] | <code>number</code> | <code>0</code> | number of pixels to add to the left edge, valid values are integers in the range 0-100000000 |
| [extend.bottom] | <code>number</code> | <code>0</code> | number of pixels to add to the bottom edge, valid values are integers in the range 0-100000000 |
| [extend.right] | <code>number</code> | <code>0</code> | number of pixels to add to the right edge, valid values are integers in the range 0-100000000 |
