...
/**
* @param {Buffer|string} reference - Buffer containing image data or string containing the path to an image file.
* @param {Object} [options]
* @param {boolean} [options.fast] - if true, use fastcor rather than spcor.
* @returns {Sharp}
* @throws {Error} Invalid parameters
*/
function correlate (referenceImage, options) {
