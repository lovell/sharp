 ...
 * @param {Number} [images[].scale=1.0] - number representing the render scaling of a vector image (SVG or PDF) proportionally to the vector image base size (e.g. SVG viewbox).
