...
function extend (extend) {
  if (is.integer(extend) && extend > 0) {
    ...
    } else if (extend.top === undefined) {
      this.options.extendTop = 0;
    } else {
      throw is.invalidParameterError('extend.top', 'integer or undefined', extend.top);
    }
    if (is.integer(extend.bottom) && extend.bottom >= 0) {
      this.options.extendBottom = extend.bottom;
    } else if (extend.bottom === undefined) {
      this.options.extendBottom = 0;
    } else {
      throw is.invalidParameterError('extend.bottom', 'integer or undefined', extend.bottom);
    }
    if (is.integer(extend.left) && extend.left >= 0) {
      this.options.extendLeft = extend.left;
    } else if (extend.left === undefined) {
      this.options.extendLeft = 0;
    } else {
      throw is.invalidParameterError('extend.left', 'integer or undefined', extend.left);
    }
    if (is.integer(extend.right) && extend.right >= 0) {
      this.options.extendRight = extend.right;
    } else if (extend.right === undefined) {
      this.options.extendRight = 0;
    } else {
      throw is.invalidParameterError('extend.right', 'integer or undefined', extend.right);
    }
