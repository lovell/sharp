...
function extend (extend) {
  if (is.integer(extend) && extend > 0) {
    ...
    is.object(extend) &&
    (!extend.top || is.integer(extend.top) && extend.top >= 0) &&
    (!extend.bottom || is.integer(extend.bottom) && extend.bottom >= 0) &&
    (!extend.left || is.integer(extend.left) && extend.left >= 0) &&
    (!extend.right || is.integer(extend.right) && extend.right >= 0)
  ) {
    this.options.extendTop = extend.top ? extend.top : 0;
    this.options.extendBottom = extend.bottom ? extend.bottom : 0;
    this.options.extendLeft = extend.left ? extend.left : 0;
    this.options.extendRight = extend.right ? extend.right : 0;
