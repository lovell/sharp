 ...
 */
function keepExif () {
  this.options.keepMetadata |= 0b000001;
  return this;
}
...
function keepIccProfile () {
  this.options.keepMetadata |= 0b001000;
  return this;
}
 ...
 */
function keepXmp () {
  this.options.keepMetadata |= 0b000010;
  return this;
}
...
/**
 * Keep Gainmap from the input image in the output image. This is the defualt behaviour for uhdr input.
 *
 * @since 0.34.3
 *
 * @example
...
function keepMetadata () {
  this.options.keepMetadata = 0b111111;
  return this;
}
 ...
 *
 * @example
 * // Convert any input to very high quality UHDR output
 * const data = await sharp(input)
 *   .uhdr({
 *     quality: 100
 *   })
 ...
 *
 * @example
 * // Use mozjpeg to reduce output UHDR file size (slower)
 * const data = await sharp(input)
 *   .uhdr({ mozjpeg: true })
 *   .toBuffer();
 *
...
function uhdr (options) {
  ...
  return this._updateFormatOut('uhdr', options);
}
