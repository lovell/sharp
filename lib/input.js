...
function _createInputDescriptor (input, inputOptions, containerOptions) {
  ...
  if (is.object(inputOptions)) {
    ...
    if (is.defined(inputOptions.raw)) {
      ...
      if (is.defined(inputOptions.raw.cicpColourPrimaries)) {
        inputDescriptor.rawCicpColourPrimaries = inputOptions.raw.cicpColourPrimaries;
        inputDescriptor.rawCicpTransferCharacteristics = inputOptions.raw.cicpTransferCharacteristics;
        inputDescriptor.rawCicpMatrixCoefficients = inputOptions.raw.cicpMatrixCoefficients;
        inputDescriptor.rawCicpFullRangeFlag = inputOptions.raw.cicpFullRangeFlag;
      }
    }
