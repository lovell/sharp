...
const minimumLibvipsVersionLabelled =
  process.env.npm_package_config_libvips /* istanbul ignore next */ ||
  config.libvips;
...
const buildSharpLibvipsIncludeDir = () => {
  try {
    return require(`@studiosnack/sharp-libvips-dev-${buildPlatformArch()}/include`);
  } catch {
    try {
      return require("@studiosnack/sharp-libvips-dev/include");
    } catch {}
  }
  /* istanbul ignore next */
  return "";
...
const buildSharpLibvipsCPlusPlusDir = () => {
  try {
    return require("@studiosnack/sharp-libvips-dev/cplusplus");
  } catch {}
  /* istanbul ignore next */
  return "";
};
...
const buildSharpLibvipsLibDir = () => {
  try {
    return require(`@studiosnack/sharp-libvips-dev-${buildPlatformArch()}/lib`);
  } catch {
    try {
      return require(`@studiosnack/sharp-libvips-${buildPlatformArch()}/lib`);
    } catch {}
  }
  /* istanbul ignore next */
  return "";
...
const yarnLocator = () => {
  try {
    ...
    const npmVersion = semverCoerce(
      optionalDependencies[`@studiosnack/sharp-libvips-${buildPlatformArch()}`],
      {
